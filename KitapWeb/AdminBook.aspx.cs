...
namespace KitapWeb
{
    public partial class AdminBook : System.Web.UI.Page
    {
        ...
        protected void LnkBtn_Update_Command(object sender, CommandEventArgs e)
        {
            ...
            tbx_UpdateBookCategoryId.Text = Convert.ToString(booksToUpdate.BookCategoryId);
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            books.BookCategoryId = Convert.ToInt32(tbx_UpdateBookCategoryId.Text);
        ...
        {
            Book books = new Book();
            books.BookCategoryId = Convert.ToInt32(tbx_AddBookCategoryId.Text);
